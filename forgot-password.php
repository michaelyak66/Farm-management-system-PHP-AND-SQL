...
<head>
    ...
    <title>Forgot Password - Green and Stretch 77 Farms</title>
    ...
    <link rel="stylesheet" href="./admin/store-assets/vendor/css/theme-default.css"
...
<body>
    ...
    <script src="./admin/store-assets/vendor/libs/jquery/jquery.js"></script>
    <script src="./admin/store-assets/vendor/libs/popper/popper.js"></script>
    <script src="./admin/store-assets/vendor/js/bootstrap.js"></script>
    <script src="./admin/store-assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>

    <script src="./admin/store-assets/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->

    <!-- Main JS -->
    <script src="./admin/store-assets/js/main.js"></script>
