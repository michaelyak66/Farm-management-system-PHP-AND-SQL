...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($job) > 20) {
        ...
        session_start();
        $_SESSION['success_message'] = "Investor details updated successfully.";


        // Redirect back to the workers-single.php page
        header("Location: investors-single.php?id=$workerId");
        exit();
    }
}
        ...
        <section class="section profile">
            <div class="row">
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            <h2 style="padding-bottom:20px;">Green House</h2>
                            <?php echo $Greenhouse; ?>
                        </div>
                    </div>
