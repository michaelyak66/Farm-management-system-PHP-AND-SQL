...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>Homepage - Green and Stretch 77 Farms Limited</title>
                ...
                <div class="col-12 col-lg-3">
                    <div class="contact-sidebar-area mb-80">
                        ...
                        <div class="single-contact-card mb-50">
                            <h4>Contact Us</h4>
                            <h3 style="font-size:25px;">(+65) 1234 5678</h3>
                            <h6>hello.colorlib@gmail.com</h6>
                            <h6>Mon - Fri: 8:00am - 6:00pm <br>Closed on Weekends</h6>
                        </div>

                        <!-- Single Sidebar Area -->
                        <div class="single-contact-card mb-50">
                            <h4>Farm Manager</h4>
                            <h3 style="font-size:25px;">(+234) 909 349 9818</h3>
                        ...
                        <div class="single-contact-card mb-50">
                            <h4>Brand & Social </h4>
                            <h3 style="font-size:25px;">(+65) 6666 5678</h3>
